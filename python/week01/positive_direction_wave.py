"""
Visualise a sinusoidal wave travelling in the positive x-direction.
...
so the point moves in the positive x-direction with phase velocity
...
print("Wave travelling in the positive x-direction")
print("------------------------------------------------")
...
print(f"Phase velocity            = {phase_velocity:.4f} units/s")
...
for t in times:
    predicted_displacement = phase_velocity * t
